...
export const pingRoutes = new Elysia()
  .get("/api/ping", () => getPingStatus(), { detail: { tags: ["Admin"], summary: "Public lightweight ping status" } })
  .get("/ping", ({ set }) => {
